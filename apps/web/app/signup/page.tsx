      ...
      <AuthShell>
        <Card className="p-7 text-center">
          ...
          <p className="mt-2 text-sm leading-relaxed text-storm-300">
            We sent a confirmation link to <span className="text-storm-100">{email}</span>. Confirm
            your address, then log in to claim your <strong>100 free starter credits</strong>.
          </p>
