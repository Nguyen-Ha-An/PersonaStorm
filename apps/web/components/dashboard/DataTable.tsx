          ...
          {rows.map((row, i) => (
            <tr
              ...
              className={clsx(
                ...
                onRowClick &&
                  "cursor-pointer transition-colors hover:bg-storm-850/60 focus-visible:bg-storm-850/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent-primary/60",
              )}
            >
              {columns.map((c) => (
                <td
