...
import { effectiveScore, toneFor, TONE_TEXT } from "./criteria-helpers";
      ...
      <div className="flex items-baseline justify-between gap-2">
        <p className="flex items-center gap-1.5 text-xs font-semibold text-storm-200">
          ...
          {!criterion.higher_is_better && (
            <span className="rounded border border-storm-600 px-1 py-px text-[9px] font-medium text-storm-400">
              barrier
            </span>
          )}
        </p>
